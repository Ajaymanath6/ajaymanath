          ...
          <div className="text-black p-8 bg-white max-w-7xl mx-auto">
            ...
            <section className="mb-12">
              ...
              <div className="flex justify-center mt-10">
                <div className="inline-flex items-center gap-3 px-6 py-4 bg-orange-50 border border-orange-200 rounded-full">
                  <i className="ri-time-line text-2xl text-orange-500"></i>
                  <span className="text-2xl sm:text-3xl font-semibold text-gray-800">Coming Soon</span>
